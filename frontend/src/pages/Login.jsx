...
import { User, Lock, Upload, ArrowRight } from 'lucide-react';
    ...
    <div className="fixed inset-0 flex items-center justify-center p-6 bg-bg-main overflow-hidden z-[100]">
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="glass-card p-10 text-center relative overflow-hidden">
          ...
          <p className="text-slate-400 mb-8">Sign in to access your OCR workspace</p>
        ...
        <p className="text-center mt-10 text-[10px] uppercase tracking-widest text-slate-600 font-bold">
          OCR Scanner Tool Pro © 2026
        </p>
      </div>
    </div>
  );
